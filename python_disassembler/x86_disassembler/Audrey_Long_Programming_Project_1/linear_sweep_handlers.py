...
class Intel_Disassembler:
    ...
    def sequential_instruction(self):
        ...
        if opcode_encoding.hasModrm and modrm_translation.hasDisp8 or opcode_encoding.hasModrm and modrm_translation.hasSib  or \
            opcode_encoding.hasModrm and modrm_translation.hasSib and modrm_value.mod == 1:

            disp8 = self.state.objectSource[current_index+instruction_length]
            instruction_length += 1

        elif opcode_encoding.hasModrm and modrm_translation.hasDisp32 or opcode_encoding.hasModrm and modrm_translation.hasSib  or \
             opcode_encoding.hasModrm and modrm_translation.hasSib and modrm_value.mod in (0,2):
